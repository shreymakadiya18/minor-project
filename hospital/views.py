...
def discharge_patient_view(request,pk):
    ...
    if request.method == 'POST':
        ...
        pDD.symptom1=patient.symptom1
        pDD.symptom2=patient.symptom2
        pDD.symptom3=patient.symptom3
        pDD.symptom4=patient.symptom4
        pDD.symptom5=patient.symptom5
...
def download_pdf_view(request,pk):
    ...
    dict={
        ...
        'symptom1':dischargeDetails[0].symptom1,
        'symptom2':dischargeDetails[0].symptom2,
        'symptom3':dischargeDetails[0].symptom3,
        'symptom4':dischargeDetails[0].symptom4,
        'symptom5':dischargeDetails[0].symptom5,
...
from mlmodel.main import message
#---------------------------------------------------------------------------------
...
def patient_dashboard_view(request):
    ...
    result=message(patient.symptom1,patient.symptom2,patient.symptom3,patient.symptom4,patient.symptom5)
    print(result)
    mydict={
    'patient':patient,
